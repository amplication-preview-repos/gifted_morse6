...
class StoreUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => TransactionUpdateManyWithoutStoresInput,
  })
  @ValidateNested()
  @Type(() => TransactionUpdateManyWithoutStoresInput)
  @IsOptional()
  @Field(() => TransactionUpdateManyWithoutStoresInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => VisitUpdateManyWithoutStoresInput,
  })
  @ValidateNested()
  @Type(() => VisitUpdateManyWithoutStoresInput)
  @IsOptional()
  @Field(() => VisitUpdateManyWithoutStoresInput, {
    nullable: true,
  })
